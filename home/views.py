...
from .forms import PostCreateUpdateForm, CommentCreateForm, CommentReplayForm
...
class PostDetailView(View):
    ...
    form_class_replay = CommentReplayForm
    ...
    def get(self, request, *args, **kwargs):
        ...
        if request.user.is_authenticated and self.post_instance.user_can_like(request.user):
            can_like = True
        return render(request, 'home/post_detail.html', {'post': self.post_instance,
...
class PostAddReplayView(LoginRequiredMixin, View):
    ...
    def post(self, request, post_id, comment_id):
        ...
        if form.is_valid():
            ...
            replay.save()
            messages.success(request, 'your replay submitted successfully', 'success')
        return redirect('home:post_detail', post.id, post.slug)
